...
public class TokenProcessor
{
     ...
     * session associated with this request</li> <li>No transaction token saved
     * in the session</li> <li>No transaction token included as a request
     ...
     */
    public synchronized boolean isTokenValid(HttpServletRequest request, boolean reset, String tokenName)
    {
        ...
        String saved = (String) session.getAttribute(tokenName);
