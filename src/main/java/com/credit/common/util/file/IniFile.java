...
public final class IniFile
{
     ...
     * method considers the following values as boolean values. <ol>
     * <li>YES/yes/Yes - boolean true</li> <li>NO/no/No - boolean false</li>
     * <li>1 - boolean true</li> <li>0 - boolean false</li> <li>TRUE/True/true -
     * boolean true</li> <li>FALSE/False/false - boolean false</li> </ol>
     * 
     * @param pstrSection
     *            the INI section name.
     * @param pstrProp
     ...
     * 
     * @param pstrSection
     *            the name of the section for which names of properties is to be
     *            retrieved.
     ...
     * 
     * @param pstrSection
     *            the name of the section for which properties are to be
     *            retrieved.
    ...
    private Properties getEnvVars()
    {
        ...
        try
        {
            ...
            if (OS.indexOf("windows 9") > -1)
            {
                ...
                {
                    // our last hope, we assume Unix (thanks to H. Ware for the
                    // fix)
                    p = r.exec("env");
                }
    ...
    private void loadFile()
    {
        ...
        try
        {
            ...
            objFRdr = new InputStreamReader(new FileInputStream(mstrFile), "GBK");
            if (objFRdr != null)
            {
                        ...
                        if (strLine == null)
                        {
                            ...
                            if (strLine.length() == 0)
                            {
                                ...
                                if (strLine.substring(0, 1).equals(";"))
                                {
                                    ...
                                    {
                                        // Section start reached create new
                                        // section
                                        if (objSec != null)
                                        ...
                                        if ((iPos = strLine.indexOf("=")) > 0 && objSec != null)
                                        {
     ...
     * @param pblnGMT
     *            If true formats the string using GMT timezone otherwise using
     *            local timezone.
    ...
    private String addRemChars(String pstrSrc)
    {
        ...
        if (pstrSrc == null)
            return null;
        // V1.0 2006-12-08 yingzf 考虑到有时pstrSrc有可能为空串 +{{
        if (pstrSrc.equals(""))
        {
            return "";
        }
    ...
    public static void main(String[] pstrArgs)
    {
        ...
        // objINI.setStringProperty("QADatabase", "OracleHome", "%ORACLE_HOME%",
        // null);
        //
        // objINI.setSectionComments("Folders", "Directories where generated
        // files are stored");
