...
public class PathUtil
{
    ...
    private static URL getClassLocationURL(final Class cls)
    {
        ...
        if (pd != null)
        {
            ...
            if (result != null)
            {
                ...
                /*
                 * 2013-04-01 huxuewen 重新排序执行逻辑 -{{ if (result != null) { }}
                 */
    ...
    /**
     * 该方法获取类所在的根路径,by xujun 如果是以class形式存在，则它获取到classes目录的上一级目录
