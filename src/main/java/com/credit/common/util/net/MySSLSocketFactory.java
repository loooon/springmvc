 ...
 *
 * Copyright (C) 2000,2013 , KOAL, Inc.
 */
...
public class MySSLSocketFactory implements ProtocolSocketFactory
{
    ...
    @Override
    public Socket createSocket(String host, int clientPort, InetAddress clientHost, int port) throws IOException, UnknownHostException
    {
