...
public class Validator
{
    ...
    public final static Pattern TELPHONE = Pattern.compile("\\d{11}");

	/** 电话 */
	public final static Pattern PHONE = Pattern.compile("\\d{3,}");
    ...
    {
        return isByRegex(TELPHONE, value);
    }
