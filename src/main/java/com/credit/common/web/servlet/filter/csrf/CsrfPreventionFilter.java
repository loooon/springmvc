 ...
 * that: <ul> <li>The filter is mapped to /*</li> <li>
...
public class CsrfPreventionFilter extends FilterBase
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        if (request instanceof HttpServletRequest && response instanceof HttpServletResponse)
        {
            ...
            {
                if (entr.equalsIgnoreCase(path) || path.endsWith("jsp") || path.endsWith("list") || path.endsWith("List")) // TODO
                {
                    skipNonceCheck = true;
                    break;
                }
    ...
    protected HttpSession getSession(HttpServletRequest request)
    {
        ...
        {
            session = SessionContext.getSession(request.getParameter("jsessionid"));
        }
    ...
    public boolean contains(Set<String> source, String str)
    {
    ...
    protected static class CsrfResponseWrapper extends HttpServletResponseWrapper
    {
        ...
        {
            super.sendRedirect(addNonce(location));
        }
        ...
        private String addNonce(String url)
        {
            ...
            if (url.contains(Constants.CSRF_NONCE_REQUEST_PARAM))
            {
                return url;
            }
            String path = url;
