...
public final class IntrospectionUtils
{
     ...
     * included in classpath by a shell script. ( java -jar also works ) Insures
     * both "install" and "home" System properties are set. If either or both
     * System properties are unset, "install" and "home" will be set to the same
     * value. This value will be the other System property that is set, or the
     ...
     * file URLs (We use Vector for JDK 1.1 compat). <p>
     *
     * @param jars
     *            The jar list
     * @param cp
